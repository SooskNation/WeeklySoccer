...
```bash
git remote add encore encore://soccer-stats-tracker-tt6i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/soccer-stats-tracker-tt6i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/soccer-stats-tracker-tt6i/settings/integrations/github)
