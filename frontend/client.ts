...
export class Client {
    ...
    public readonly players: players.ServiceClient
    public readonly stats: stats.ServiceClient
    public readonly votes: votes.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.players = new players.ServiceClient(base)
        this.stats = new stats.ServiceClient(base)
        this.votes = new votes.ServiceClient(base)
    }
...
import { deleteGame as api_games_delete_deleteGame } from "~backend/games/delete";
...
export namespace games {
    ...
    export class ServiceClient {
         ...
         */
        public async create(params: RequestType<typeof api_games_create_create>): Promise<ResponseType<typeof api_games_create_create>> {
            // Now make the actual call to the API
        ...
        public async deleteGame(params: { id: number }): Promise<ResponseType<typeof api_games_delete_deleteGame>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/games/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_games_delete_deleteGame>
        }
         ...
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_games_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/games/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_games_get_get>
        }

        /**
         * Lists all games ordered by date descending.
         */
        public async list(): Promise<ResponseType<typeof api_games_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/games`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_games_list_list>
        }

        /**
         * Updates an existing game and its statistics.
         */
        public async update(params: RequestType<typeof api_games_update_update>): Promise<ResponseType<typeof api_games_update_update>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
                blackScore: params.blackScore,
                date:       params.date,
                stats:      params.stats,
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_games_update_update>
        }
    }
}
...
export namespace players {
    ...
    export class ServiceClient {
         ...
         */
        public async create(params: RequestType<typeof api_players_create_create>): Promise<ResponseType<typeof api_players_create_create>> {
            // Now make the actual call to the API
         ...
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_players_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/players/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_players_get_get>
        }

        /**
         * Lists all players.
         */
        public async list(): Promise<ResponseType<typeof api_players_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/players`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_players_list_list>
        }
        ...
        public async update(params: RequestType<typeof api_players_update_update>): Promise<ResponseType<typeof api_players_update_update>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/players/${encodeURIComponent(params.id)}`, {method: "PUT", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_players_update_update>
        }
    }
}
...
export namespace stats {
    ...
    export class ServiceClient {
         ...
         */
        public async leaderboard(): Promise<ResponseType<typeof api_stats_leaderboard_leaderboard>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/stats/leaderboard`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_stats_leaderboard_leaderboard>
        }

        /**
         * Retrieves aggregated statistics for a player.
         */
        public async playerStats(params: { id: number }): Promise<ResponseType<typeof api_stats_player_playerStats>> {
            // Now make the actual call to the API
...
export namespace votes {
    ...
    export class ServiceClient {
         ...
         */
        public async results(params: { gameId: number }): Promise<ResponseType<typeof api_votes_results_results>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/votes/${encodeURIComponent(params.gameId)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_votes_results_results>
        }

        /**
         * Submits a vote for Man of the Match.
         */
        public async submit(params: RequestType<typeof api_votes_submit_submit>): Promise<ResponseType<typeof api_votes_submit_submit>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/votes`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_votes_submit_submit>
        }
    }
}
